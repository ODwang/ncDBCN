...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans: int = 1, num_classes: int = 13, depths: list = None,
                 dims: list = None, drop_path_rate: float = 0., layer_scale_init_value: float = 1e-6,
                 head_init_scale: float = 1.):
        super().__init__()
        # 最初下采样部分
        self.BiGRU_profile = nn.GRU(input_size=100, hidden_size=512, num_layers=3, bidirectional=True)
        # self.LSTM = nn.LSTM(input_size=1024,hidden_size=1024,num_layers=1)
